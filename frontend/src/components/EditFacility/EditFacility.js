...
import { FactoryContext, EditFacilityContext } from "../../stores";
...
const EditFacility = () => {
  ...
  //   const [inputRewritePassword, setInputRewritePassword] = useState("");
  ...
  const getFactoryProducts = useContext(FactoryContext)[1];
